...
// ожидает почту и действие которое нужно выполнить - ссылку на
// метод объекта service.Сбор статистики симулиуется логированием строки.
...
// рефакторинг:
console.log(logAndInvokeAction('kiwi@mail.uk',
...
// рефакторинг:
console.log(logAndInvokeAction('poly@hotmail.de',
